...
$txt['attachment_image_reformat'] = 'Allow non-JPEG images to be reformatted to JPEG format when resizing.';
...
$txt['helpattachment_image_enabled'] = 'Files will be rencoded if they are larger than the below dimensions';
$txt['helpattachment_image_enabled_size'] = 'or large than %s KB.';
$txt['help_attachment_image_reformat'] = 'Selecting this option will allow the system to reformat non-JPEG images into the JPEG format when necessary.  The system will try to maintain the existing format unless the resulting image is still in excess of the maximum file size allowed.';
